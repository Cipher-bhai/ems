...
const fetchSummary  = async () =>{
    try{
     const summary = await axios.get('https://ems-backend-hkt0.onrender.com/api/dashboard/summary',{ 
      headers:{
...
if(!summary){
  ...
  return (
   ...
   <div className='mt-12'>
     ...
     <SummaryCard  icon={< FaFile/>} text="Leave Applied" number={summary.leaveSummary.appliedFor} color="bg-teal-600" />  
